...
public class FifoQueue<E> {
	...
	/**
	 * Παίρνουμε την τιμή ενός συγκεκριμένου κόμβου σύμφωνα με τον δείκτη
	 * χωρίς όμως να τον αφαιρέσουμε από την ουρά.
	 * 
	 * @param index Η θέση του κόμβου στην ουρά.
	 * @return Την τιμή του κόμβου που μας ενδιαφέρει.
	 * @throws IndexOutOfBoundsException Σε περίπτωση που ο δείκτης είναι 
	 * μικρότερος του μηδέν ή μεγαλύτερος του μεγέθους της ουράς.
	 * @see FifoQueue#getNode(int)
	 * @see QNode#getValue()
	 */
